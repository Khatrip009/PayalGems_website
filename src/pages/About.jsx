    ...
    <div className="min-h-screen bg-cream py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="space-y-8 text-charcoal text-lg leading-relaxed">
          <p>
            For over three decades, <span className="font-semibold text-gold-600">PayalGEMS</span> has been synonymous
          ...
          <p>
            ...
            perfect engagement ring, PayalGEMS promises a personal, luxurious experience
